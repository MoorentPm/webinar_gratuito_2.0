    ...
    <div className="bg-background font-sans text-foreground antialiased overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 px-4 sm:px-6 lg:px-8 hero-dark-bg" data-testid="section-hero">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="space-y-8 animate-fade-in">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light leading-tight text-white" data-testid="text-hero-title">
              Trasforma il Tuo Immobile in un{" "}
              <span className="block font-semibold">Asset Redditizio</span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 font-light max-w-3xl mx-auto leading-relaxed px-4" data-testid="text-hero-subtitle">
      ...
      <div className="relative hero-dark-bg text-white">
        ...
        <div className="relative z-10">
          {/* Video Section */}
          <section id="webinar" className="py-20 px-4 sm:px-6 lg:px-8 scroll-reveal" data-testid="section-webinar">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light mb-6" data-testid="text-webinar-title">
                  Il Tuo Immobile, Il Tuo <span className="font-semibold">Successo</span>
                </h2>
                <p className="text-xl text-gray-300 font-light max-w-3xl mx-auto" data-testid="text-webinar-subtitle">
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 scroll-reveal" data-testid="section-resources">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                  <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light mb-6" data-testid="text-resources-title">
                    Risorse <span className="font-semibold">Esclusive</span> per Te
                  </h2>
                  <p className="text-xl text-gray-300 font-light max-w-3xl mx-auto" data-testid="text-resources-subtitle">
                    Accedi a strumenti e guide professionali per ottimizzare da subito la gestione del tuo immobile.
                  </p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center hover-lift p-8 rounded-2xl flex flex-col items-center" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(10px)' }} data-testid="card-resource-1">
                ...
                <div className="text-center hover-lift p-8 rounded-2xl flex flex-col items-center" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(10px)' }} data-testid="card-resource-2">
                  <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mb-6">
                ...
                <div className="text-center hover-lift p-8 rounded-2xl flex flex-col items-center" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(10px)' }} data-testid="card-resource-3">
                  <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mb-6">
          ...
          {/* Newsletter Section */}
          <section id="newsletter" className="py-20 px-4 sm:px-6 lg:px-8 scroll-reveal" data-testid="section-newsletter">
            <div className="max-w-4xl mx-auto">
              <div className="premium-gradient-dark rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
                <div className="mb-8">
                  <h2 className="text-3xl sm:text-4xl font-light mb-6" data-testid="text-newsletter-title">
                    Ricevi Strategie <span className="font-semibold">Esclusive</span> via Email
                  </h2>
                  <p className="text-lg sm:text-xl text-gray-300 font-light max-w-2xl mx-auto leading-relaxed px-4" data-testid="text-newsletter-subtitle">
                ...
                <form className="max-w-md mx-auto space-y-6" data-testid="form-newsletter">
          ...
          {/* Contact Section */}
          <section id="contatti" className="py-20 px-4 sm:px-6 lg:px-8 scroll-reveal" data-testid="section-contatti">
            <div className="max-w-4xl mx-auto text-center">
              <div className="mb-16">
                <h2 className="text-3xl sm:text-4xl font-light mb-6" data-testid="text-contact-title">
                  Vuoi Parlare <span className="font-semibold">Direttamente</span> con Noi?
                </h2>
                <p className="text-xl text-gray-300 font-light max-w-3xl mx-auto leading-relaxed" data-testid="text-contact-subtitle">
